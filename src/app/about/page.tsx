  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-red-100 via-white to-red-200 text-gray-800">
      ...
      <p className="text-lg text-gray-600 max-w-md text-center mb-8">
        This is your about page — simple, elegant, and clean. Feel free to
        explore and make it your own.
      </p>
      <button className="px-6 py-3 bg-red-600 text-white font-semibold rounded-2xl shadow-lg hover:bg-blue-700 transition duration-300">
        Get Started
      </button>
    </div>
  );
